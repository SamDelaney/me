...
class ArcballControl {
  ...
  constructor(canvas, updateCallback) {
    this.canvas = canvas;
    this.updateCallback = updateCallback || (() => void 0);
  ...
  update(deltaTime, targetFrameDuration = 16) {
    const timeScale = deltaTime / targetFrameDuration + 1e-5;
...
class InfiniteGridMenu {
      ...
      this.items.map(
        (item) => new Promise((resolve) => {
          ...
          img.onerror = (error) => {
            ...
            const gradient = fallbackCtx.createRadialGradient(
              cellSize / 2,
              cellSize / 2,
              0,
              cellSize / 2,
  ...
  animate(deltaTime) {
    ...
    const positions = this.instancePositions.map(
      (p) => vec3.transformQuat(vec3.create(), p, this.control.orientation)
    );
    const scale = 0.25;
  ...
  onControlUpdate(deltaTime) {
    const timeScale = deltaTime / this.TARGET_FRAME_DURATION + 1e-4;
...
const InfiniteMenu = ({ items = [] }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative w-full h-full text-white", children: [
    /* @__PURE__ */ jsx(
      "canvas",
      {
    ...
    activeItem && /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(
        "h2",
        {
          className: `
      ...
      /* @__PURE__ */ jsx(
        "p",
        {
          ...
          transition-all
          ease-[cubic-bezier(0.25,0.1,0.25,1.0)]
          ${isMoving ? "opacity-0 pointer-events-none duration-[100ms] translate-x-[-60%] -translate-y-1/2" : "opacity-100 pointer-events-auto duration-[500ms] translate-x-[-60%] -translate-y-1/2"}
        `,
      ...
      /* @__PURE__ */ jsx(
        ...
        `,
          children: /* @__PURE__ */ jsx("p", { className: "select-none relative text-[#060010] top-[2px] text-[26px]", children: "↗" })
        }
      )
    ] })
  ] });
...
function App() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "h-[calc(100vh-80px)]", children: /* @__PURE__ */ jsx(InfiniteMenu, { items }) });
}
export {
  App as component
};
