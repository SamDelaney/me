...
function BlockchainWork() {
  const projects = [{
    ...
    description: "Created a gas-efficient NFT marketplace with automatic royalty distribution and batch minting capabilities.",
    ...
    description: "Implemented a trustless bridge for asset transfers between Ethereum and Polygon using merkle proofs.",
    ...
    description: "Developed a flexible governance system with delegation, proposal templates, and automated execution.",
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center min-h-screen bg-gradient-to-br from-zinc-800 to-black p-4 text-white", style: {
    ...
    /* @__PURE__ */ jsx("h1", { className: "text-4xl font-bold mb-4 text-center bg-gradient-to-r from-orange-400 to-pink-400 bg-clip-text text-transparent", children: "Blockchain Projects" }),
    /* @__PURE__ */ jsx("p", { className: "text-lg text-center text-gray-300 mb-8", children: "Decentralized applications and smart contract systems" }),
    /* @__PURE__ */ jsx("div", { className: "grid gap-6", children: projects.map((project) => /* @__PURE__ */ jsxs("div", { className: "bg-white/5 border border-white/20 rounded-xl p-6 backdrop-blur-sm", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start mb-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsx("a", { href: project.github, className: "px-3 py-1 bg-gray-700 hover:bg-gray-600 text-white rounded-lg text-sm transition-colors", target: "_blank", rel: "noopener noreferrer", children: "GitHub" }),
          /* @__PURE__ */ jsx("a", { href: project.live, className: "px-3 py-1 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-sm transition-colors", target: "_blank", rel: "noopener noreferrer", children: "Live Demo" })
        ] })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-300 mb-4 leading-relaxed", children: project.description }),
      /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
        /* @__PURE__ */ jsx("p", { className: "text-orange-300 font-medium mb-2", children: "Key Metrics:" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-400", children: project.metrics })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: project.technologies.map((tech) => /* @__PURE__ */ jsx("span", { className: "px-3 py-1 bg-orange-500/20 text-orange-300 rounded-full text-sm border border-orange-400/30", children: tech }, tech)) })
    ] }, project.name)) })
  ] }) });
}
export {
  BlockchainWork as component
};
